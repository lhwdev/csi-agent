...
def record_interactive(robot: Robot, leader: Teleoperator, params=None):
    """
    ...
    top_camera_widget = widgets.Image(format='jpeg', width=240, height=180, layout=widgets.Layout(border="1px solid #ccc", border_radius="8px"))
    ...
    def on_init_clicked(b):
        ...
        try:
            ...
            # Cameras and features are automatically read from robot.observation_features
            pass
    ...
    async def main_loop():
        ...
        try:
            while keep_running:
                ...
                # 1. Get robot observation and leader action
                # robot.get_observation() retrieves both joints and camera frames automatically
